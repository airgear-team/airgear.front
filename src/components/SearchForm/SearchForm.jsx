...
const SearchForm = () => {
    ...
    const findLocation = (e) => {
            ...
            if(e.target.value.length>2){
                fetch(`http://localhost:8083/locations/?prefix=${e.target.value}`, {
                    method: 'GET',
                    credentials: 'include',
                    headers: {
                        'Accept': 'application/json'
    ...
    return (
        <div className={styles.container}>
            <div className={styles.search}>
                ...
                <input type="text" value={location} onInput={findLocation} onChange={(e) => setLocation(e.target.value)} placeholder="Ukraine" className={styles.locationInput} />
