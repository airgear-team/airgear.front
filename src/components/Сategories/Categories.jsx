...
const images = [
    { src: image1, id: 3, label: 'Appliances' },
    { src: image2, id: 8, label: 'Beauty & Health' },
    { src: image3, id: 4, label: 'Clothes & Accessories' },
    { src: image4, id: 9, label: 'Event Goods' },
    { src: image5, id: 1, label: 'Property' },
    { src: image6, id: 5, label: 'Recreational Equipment' },
    { src: image7, id: 7, label: 'Sport Equipment' },
    { src: image8, id: 6, label: 'Tools & Equipment' },
    { src: image9, id: 2, label: 'Transport Equipment' },
];
